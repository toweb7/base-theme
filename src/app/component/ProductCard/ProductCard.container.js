...
import { registerSharedElement } from 'Store/SharedTransition/SharedTransition.action';
...
export const mapDispatchToProps = dispatch => ({
    ...
    registerSharedElement: reactRef => dispatch(registerSharedElement(reactRef))
});
